...
private slots:
    ...
    QString BuyCSA(QString OrderType, double Quantity, double Rate);
    QString SellCSA(QString OrderType, double Quantity, double Rate);
