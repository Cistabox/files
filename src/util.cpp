...
int nAnonymizeCistaAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Cista
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Cista
    // Mac: ~/Library/Application Support/Cista
    // Unix: ~/.Cista
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Cista";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Cista.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Cistad.pid"));
